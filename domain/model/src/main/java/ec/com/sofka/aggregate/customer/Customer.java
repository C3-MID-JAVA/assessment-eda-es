...
public class Customer extends AggregateRoot<CustomerId> {
        ...
        public static Mono<ec.com.sofka.aggregate.customer.Customer> from(final String id, Flux<DomainEvent> events) {
            ec.com.sofka.aggregate.customer.Customer customer = new ec.com.sofka.aggregate.customer.Customer(id);
            return events
