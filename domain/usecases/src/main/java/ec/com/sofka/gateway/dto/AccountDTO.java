...
public class AccountDTO {
    ...
    public AccountDTO(String id, String name, String accountNumber, BigDecimal balance, AccountStatusEnum status) {
        this.id = id;
    ...
    public AccountDTO(String name, String accountNumber, BigDecimal balance, AccountStatusEnum status) {
        this.balance = balance;
        this.name = name;
        this.accountNumber = accountNumber;
        this.status = status;
