...
public class UpdateAccountRequest extends Request {
    ...
    public UpdateAccountRequest(final String aggregateId, final String accountId, final String accountNumber, final BigDecimal accountBalance, final String accountHolder, final Boolean accountIsActive) {
        super(aggregateId);
